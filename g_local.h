...
#define WEAP_NONE               23
// petunindan rose
#define WEAP_LASER              24
#define WEAP_PLASMAGUN          25
#define DNA_CAPTURED          	0
...
// petunindan tad
extern	int	plasma_cells_index;
extern	int	proximity_grenades_index;
//
...
// petunindan rose
void monster_fire_gladlaser (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int kick, int flashtype);
//
...
// petunindan rose
void fire_gladlaser (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int kick);
//
...
//petunindan tad
void fire_tadplasma (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius, int radius_damage);
//
