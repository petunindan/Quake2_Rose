...
void traitor_run (edict_t *self)
{
	...
	if (self->common_name = "Female Traitor")
...
void TraitorBfg (edict_t *self)
{
	...
	monster_fire_bfg (self, start, forward, 160, 500, 300, 200, MZ2_JORG_BFG_1);
}
...
mmove_t traitor_move_fire_plasma = {45, 50, traitor_frames_fire_plasma, traitor_refire_allguns};
...
mmove_t traitor_move_fire_bfg = {45, 50, traitor_frames_fire_bfg, traitor_refire_allguns};
...
mmove_t traitor_move_fire_rocket = {45, 50, traitor_frames_fire_rocket, traitor_refire_allguns};
...
mmove_t traitor_move_fire_chain1 = {45, 46, traitor_frames_fire_chain1, traitor_refire_chain1};
//
...
mmove_t traitor_move_endfire_chain_cloakon = {51, 53, traitor_frames_endfire_chain_cloakon, traitor_run};
//
...
//				gi.dprintf ("blindfire - NO SHOT\n");
		...
		if (gunner_grenade_check(self))
		{
			...
			{
				self->monsterinfo.currentmove = &traitor_move_fire_hyper1;
			}
			else
			{
...
void SP_monster_traitor (edict_t *self)
{
	...
	sound_death = gi.soundindex ("player/male/death1.wav");	
	sound_pain = gi.soundindex ("player/male/pain100_1.wav");	
	sound_pain2 = gi.soundindex ("player/male/pain100_2.wav");	
	sound_idle = gi.soundindex ("gunner/gunidle1.wav");	
	sound_open = gi.soundindex ("gunner/gunatck1.wav");	
	sound_search = gi.soundindex ("gunner/gunsrch1.wav");	
...
void SP_monster_traitor_female (edict_t *self)
{
	...
	sound_death = gi.soundindex ("player/female/death1.wav");	
	sound_pain = gi.soundindex ("player/female/pain100_1.wav");	
	sound_pain2 = gi.soundindex ("player/female/pain100_2.wav");	
	sound_idle = gi.soundindex ("gunner/gunidle1.wav");	
	sound_open = gi.soundindex ("gunner/gunatck1.wav");	
	sound_search = gi.soundindex ("gunner/gunsrch1.wav");	
