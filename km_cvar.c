...
// petunindan rose
cvar_t	*box_proximity_grenades; //value of rose grenade pack
//
cvar_t	*box_rockets; //value of rocket pack
cvar_t	*box_cells; //value of cell pack
// petunindan tad
cvar_t	*box_plasma_cells; //value of plasma cell pack
//
...
void lithium_defaults(void)
{
	...
	box_proximity_grenades = gi.cvar("box_proximity_grenades", "5", 0);
	box_rockets = gi.cvar("box_rockets", "5", 0);
	box_cells = gi.cvar("box_cells", "50", 0);
	// petunindan tad
	box_plasma_cells = gi.cvar("box_plasma_cells", "5", 0);
	//
	...
	// petunindan rose
	pack_proximity_grenades = gi.cvar("pack_proximity_grenades", "100", 0);
	//
	// petunindan tad
	pack_plasma_cells = gi.cvar("pack_plasma_cells", "50", 0);
	//
	...
	//petunindan tad
	bando_plasma_cells = gi.cvar("bando_plasma_cells", "80", 0);
	//
	...
	//petunindan tad
	max_plasma_cells = gi.cvar("max_plasma_cells", "50", 0);
	//
	...
	// petunindan rose
	max_proximity_grenades = gi.cvar("max_proximity_grenades", "50", 0);
