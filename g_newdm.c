...
char *FindSubstituteItem (edict_t *ent)
{
	...
	for (i=0 ; i<game.num_items ; i++, it++)
	{
		...
		if ( ((int)dmflags->value & DF_NO_MINES) && 
				(!strcmp(ent->classname, "ammo_prox") || !strcmp(ent->classname, "ammo_tesla") || (!strcmp(ent->classname, "ammo_proximity_grenades") || !strcmp(ent->classname, "ammo_proximity_grenades") ))
			)
			continue;
