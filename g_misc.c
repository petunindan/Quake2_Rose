...
// petunindan 
// edited for tad purposes
void misc_eastertank_die (edict_t *ent)
{
	int		n;
	int damage;
	...
	for (n= 0; n < 8; n++)
		ThrowGib (ent, "models/objects/gibs/gear/tris.md2", damage, GIB_METALLIC);
	ThrowGib (ent, "models/objects/gibs/chest/tris.md2", damage, GIB_ORGANIC);
	ThrowHead (ent, "models/objects/gibs/gear/tris.md2", damage, GIB_METALLIC);
