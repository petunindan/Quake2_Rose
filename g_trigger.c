...
// petunindan tad
// I spent two days looking for a solution, but I couldn't! Hope someone fixes this :)
void SP_trigger_dna (edict_t *self)
{
	SP_trigger_once (self);
}
//

//numeric final tda combination

extern void button_wait_combi (edict_t *self);

void SP_trigger_combi (edict_t *self)
{
	SP_trigger_once (self);
}
