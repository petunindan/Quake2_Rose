...
***
Edited by Petunindan for Rose purposes:
added Rose monster spawns
26.05.2021
***
...
// petunindan Rose
void SP_monster_soldier_screen (edict_t *self);
...
void SP_monster_parasite_prox (edict_t *self);
void SP_func_combi_button (edict_t *ent);
void SP_trigger_combi (edict_t *ent);
...
void SP_trigger_dna (edict_t *self);
...
//Knightmare- experiment gekks
	...
	// petunindan Rose/tad
	{"monster_soldier_screen", SP_monster_soldier_screen},
	{"monster_flyer_hornet", SP_monster_flyer_hornet},
	{"monster_gladiator_laser", SP_monster_gladiator_laser},
	{"monster_tank_general", SP_monster_tank_general},
	{"monster_hypertank", SP_monster_hypertank},
	{"monster_death_tank", SP_monster_death_tank},
	{"monster_traitor", SP_monster_traitor},
	{"monster_traitor_female", SP_monster_traitor_female},
	{"monster_traitor_boss", SP_monster_traitor_boss},
	{"monster_parasite_prox", SP_monster_parasite_prox},
	{"func_combi_button", SP_func_combi_button},
	{"trigger_combi", SP_trigger_combi},
...
void SP_worldspawn (edict_t *ent)
{
	...
	if (use_vwep->value || deathmatch->value)
	{
		...
		// petunindan tad
		gi.modelindex ("#g_plasma.md2");			// Knightmare added
		//
