...
void SelectStartWeapon (gclient_t *client, int style)
{
	...
	if (style)
	{
		...
		// petunindan tad
		client->pers.inventory[plasma_cells_index]    = 0;
		client->pers.inventory[proximity_grenades_index]    = 0;
		//
...
void InitClientPersistant (gclient_t *client, int style)
{
	...
	// petunindan tad
	client->pers.max_plasma_cells		= max_plasma_cells->value;
	//
...
//ROGUE
	...
	// petunindan rose
	client->pers.max_proximity_grenades		= max_proximity_grenades->value;
	//
