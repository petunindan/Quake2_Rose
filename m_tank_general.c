...
//
// monster_tank_general
//

/*QUAKED monster_tank_general (1 .5 0) (-32 -32 -16) (32 32 72) Ambush Trigger_Spawn Sight GoodGuy NoGib HomingRockets
*/
